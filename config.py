...
COOKIE_RULES = [
    ...
    # 与上面同为 SESSION，但来自 finance-report.sto.cn，上报 key 用 fin_report_session
    ('finance-report.sto.cn', 'SESSION', lambda n, v: f'fin_report_session={v}'),
    ...
    ('page.sto.cn', 'TOKEN', lambda n, v: f'{n}={v}'),
]
